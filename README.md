...
1. ``recurrence2`` - дополнительное задание которое не входит, ни в базовую, ни в продвинутую часть, но будет круто, если кто-то сможет объяснить обычный алгоритм ``recurrence`` не работает. Условие задачи полностью совпадает с задачей ``recurrence``
